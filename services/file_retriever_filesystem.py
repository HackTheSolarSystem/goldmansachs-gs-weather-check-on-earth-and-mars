...
def retrieve_from_server(planet_name, image_file_path, date_yyyyMMdd, time_hhmm):
   ...
   image_file_name=get_filename(image_file_path) + "_" + date_yyyyMMdd + "_" + time_hhmm
   image_file_extension = get_extension(image_file_path)

   destination_file_name = directory + image_file_name + image_file_extension
   copyfile(image_file_path, destination_file_name)
...
if __name__ =='__main__':
   retrieve_from_server('earth', 'vine-1948358_1280_20180202_0000.png', '20180202', '0000')